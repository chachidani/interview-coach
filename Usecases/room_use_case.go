...
func (r *roomUsecase) AddMessageToRoom(c context.Context, roomID primitive.ObjectID, message domain.Message) (domain.Room, error) {
...
func (r *roomUsecase) DeleteRoom(c context.Context, roomID primitive.ObjectID) error {
	return r.roomRepository.DeleteRoom(c, roomID)
}

// GetRoom implements domain.RoomUsecase.
func (r *roomUsecase) GetRoom(c context.Context, roomID primitive.ObjectID) (domain.Room, error) {
...
func (r *roomUsecase) UpdateRoom(c context.Context, roomID primitive.ObjectID, room domain.Room) (domain.Room, error) {
